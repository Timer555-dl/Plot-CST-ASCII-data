...
%
%% User input:
file_path = 'H:\Simon_data\s_1_1.txt'; 
n_data_pts = 1001; % Number of data points in CST (1001 is default).
n_s_para = 1; % Number of different s-parameters.

% Customize plot:
plt.color = 'r -';      % Plot color and line style (b, g, r, y, k, ...; -, --, ...).
...
%% Plot data
hold on
plot(s_params{1,1}{1,1}(:,1), s_params{1,1}{1,1}(:,2), plt.color, 'LineWidth', plt.line_width, 'DisplayName', plt.legend);
hold off
